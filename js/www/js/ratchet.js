...
!function () {
  ...
  window.addEventListener('touchstart', function (e) {
    ...
    // toggle.style['-webkit-transition-duration'] = 0; // OFF for both
  });
  ...
  window.addEventListener('touchmove', function (e) {
    ...
    if (distanceX < 0)      return ;//handle.style.webkitTransform = 'translate3d(0,0,0)'; // OFF for Android
    if (distanceX > offset) return ;//handle.style.webkitTransform = 'translate3d(' + offset + 'px,0,0)'; // OFF for Android
 
    // handle.style.webkitTransform = 'translate3d(' + distanceX + 'px,0,0)'; // OFF for Android
  ...
  window.addEventListener('touchend', function (e) {
    ...
    // if (slideOn) handle.style.webkitTransform = 'translate3d(' + offset + 'px,0,0)'; // OFF for Android
    // else handle.style.webkitTransform = 'translate3d(0,0,0)'; // OFF for Android
